module github.com/bhandras/delight/webclient
...
require (
	github.com/bhandras/delight/cli v0.0.0
...
require (
	...
	github.com/zishang520/socket.io/clients/socket/v3 v3.0.0-rc.9 // indirect
...
replace github.com/bhandras/delight/cli => ../cli
